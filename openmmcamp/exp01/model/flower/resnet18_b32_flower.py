...
log_level = 'INFO'
load_from = '/HOME/scz0arc/run/mmclassification/checkpoints/resnet18_batch256_imagenet_20200708-34ab8f90.pth'
resume_from = None
workflow = [('train', 1)]
...
work_dir = '/HOME/scz0arc/run/mmclassification/work/flower'
gpu_ids = [0]
